...
def calculate_deposit(customer, car):
    try:
        ...
        print("Error: Failed to calculate deposit due to value error.")
        return None
    except KeyError:
        print("Error: Missing required keys in customer or car data.")
        return None
    except Exception as e:
        print(f"An unexpected error occurred during deposit calculation: {str(e)}")
        return None
...
def calculate_payment(customer, car):
    try:
        ...
        print("Error: Failed to calculate payment due to value error.")
        return None
    except KeyError:
        print("Error: Missing required keys in customer or car data.")
        return None
    except Exception as e:
        print(f"An unexpected error occurred during payment calculation: {str(e)}")
        return None
