# Madhumitha was working as an Accountant in BINNI mills Pvt Ltd, Coimbatore.
# She was in charge of crediting salary for all the employees, summarising the current financial status by collecting information,
#     preparing balance sheet, profit, and loss statement, and other reports.
# That particular day she was assigned to generate a report that contains the Date of Joining of employees between
# years 1980 - 2015 in the format (yyyy, MMM,dd). But the date of joining which is available in the present datasheet
# is in the format DD-MMM-YY. Help her to convert the date of joining of all the employees to (DD, MMM, yyyy) format by writing a program.
# Note 
...
# Create a  function named date_decoder( ) that takes a date in the "dd-MMM-yy" format as its argument.
# Translate the month, correct the year to include all of the digits and respond with the format of (yyyy,MMM,dd).
# Input format:
