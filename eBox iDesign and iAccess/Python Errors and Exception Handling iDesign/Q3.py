...
# If the marks is less than 90, a custom Exception named NotEligibleException is raised
# and an appropriate message as shown in the sample output is displayed.
